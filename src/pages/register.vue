...
<template>
  <NavBarSecondary
    ...
    absolute right-0 top-0 mt-4 flex-row justify-center
  />
  <main
    class="mx-auto mt-6 w-1/2 flex-col items-center px-4 py-10 text-center"
    dark:bg-dark-600
  >
